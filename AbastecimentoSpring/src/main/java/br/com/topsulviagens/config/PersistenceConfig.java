...
@EnableJpaRepositories(basePackages = "br.com.topsulviagens.dao", entityManagerFactoryRef = "entityManagerFactory", transactionManagerRef = "transactionManager")
public class PersistenceConfig {
	...
	public DataSource datasource() {
		...
		ds.setUrl("jdbc:mysql://localhost:3306/abast?serverTimezone=UTC");
		ds.setUsername("root");
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactoryBean(DataSource ds) {
		...
		emfb.setPackagesToScan("br.com.topsulviagens.model");
